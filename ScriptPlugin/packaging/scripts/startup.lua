-- startup.lua: version 1.2
-- This file is part of the DC Scripting plugin.
--
-- NMDC Listeners:
--   chat		= normal chat message (you won't get your own messages)
--   			  f( hub, user, "message" )
--   			  DISCARDABLE:
--   			    * return non-nil to hide the msg from the client,
		...
		if sid == "HUB9" and inf then
			...
			for k in pairs(params) do
				...
				elseif name == "DE" then
					...
					this:addLine("The hub topic is set to: " .. DE)
				end
			end
		end
...
-- Add scripts you want to run here.

dofile(DC():GetScriptPath() .. "adccommands.lua")
dofile(DC():GetScriptPath() .. "uptime.lua")
